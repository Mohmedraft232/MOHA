...
function lab_crops_menu()
    ...
    if choice == 16 then -- Special case: Replaces Alfalfa (7024)
        gg.alert("افتح الزرع الأول واختار برسيم حجازي وانتظر انتهاء العد.")
        ...
        if #results > 0 then
            ...
            gg.alert("لم يتم العثور على البرسيم الحجازي ")
        end
    ...
    if target_code then
        gg.alert("افتح الزرع الأول واختار الشوفان  وانتظر انتهاء العد.")
        ...
        if #results > 0 then
            ...
            gg.alert("لم يتم العثور على الشوفان")
        end
    end
...
function neighbor_requests_menu()
    local menu = {
      " اختيار الكل✔️",
			...
			" اداة مطور الغزلان ",
			" اداة مطور النعامة",
			" اداة مطور الثور الفرنسي🐂",
			" اداة مطور الديك الرومي🐔",
			" اداة مطور المخبز🍞",
			" اداة مطور معمل الجبن🎆",
			" اداة مطور الطاحونة🌾",
			" اداة مطور الصلصة🍅",
			" اداة مطور الة العصير🍷",
			" اداة مطور الة المربي🍨",
			" اداة مطور الحلوي🍬",
			" اداة مطور الة السكر🍺",
			" اداة مطور عصارة العنب🍇",
			" اداة مطور باقة الزهور💐",
			" اداة مطور الة البرغر🍔",
			" اداة مطور دمي الدببة 🐼",
			" اداة مطور البسطرمة 🍖",
			" لوح زجاجي للمختبر🔍",
			" سياج شجره الصداقه🚧",
			"رجوع🔙"
